...
# 임금받는 시간 단위 변수 제거 -> 변환 하나도 안됨 why?
# df20 <- subset(df20,select=-c(y14b224))


# 생성한 데이터프레임 저장
write.csv(df16, file="C:/Users/kimch/Desktop/의생명통계/기말프로젝트/df16.csv")
write.csv(df17, file="C:/Users/kimch/Desktop/의생명통계/기말프로젝트/df17.csv")
write.csv(df18, file="C:/Users/kimch/Desktop/의생명통계/기말프로젝트/df18.csv")
write.csv(df19, file="C:/Users/kimch/Desktop/의생명통계/기말프로젝트/df19.csv")
write.csv(df20, file="C:/Users/kimch/Desktop/의생명통계/기말프로젝트/df20.csv")
